...
public class MainActivity extends AppCompatActivity implements
    ...
    private void getLastKnownLocation() {
        Log.d(TAG, "getLastKownLocation: called");
        ...
        mFusedLocationClient.getLastLocation().addOnCompleteListener(new OnCompleteListener<Location>() {
            ...
            public void onComplete(@NonNull Task<Location> task) {
                if (task.isSuccessful()){
                    ...
                    Log.d(TAG,"on complete latitude "+geoPoint.getLatitude());
                    Log.d(TAG,"on complete longitude "+geoPoint.getLongitude());

                    userLocation.setGeoPoint(geoPoint);
                    userLocation.setTimetamp(null);
                    savedUserLocation();
                }
